...
#define DHTPIN            2         // Pin which is connected to the DHT sensor. (D4)
...
DHT_Unified dht(DHTPIN, DHTTYPE); //ส่งค่า 2 ตัว 
...
const char *userid = "000974";            //IoTtweet account user ID (6 digits, included zero pre-fix)
const char *key = "74ac0a558dtz";     //IoTtweet registered device key in "MY IOT Garage"
